...
description: >
  ...
  "say stop" line rather than waiting to be asked; only a live chat can self-fire.
---
...
**Canonical home: the operator's ruling of 2026-08-15 that the handoff has no gate on the path he actually uses.** The
...
(His clause, verbatim. Home: the operator's ruling of 2026-08-15 that the handoff has no gate on the path he actually uses. Honest limit: nothing can refuse a session that decides to stop — this instructs, it does not enforce. The measurable residue is a session_log row left `active` with no handoff behind it.)
