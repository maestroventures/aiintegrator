...
Recorded on three internal cards of 2026-08-07 to 2026-08-10 (piece 2 of the first).*

*v1.4 — 2026-08-06. Step 3 gains one clause: **a rendered affordance is not an ask.** Adopt-sharpen
(pop-up-approved by the operator 2026-08-06, T14 S74). Step 3 already ruled the SHAPE of an offer — one item at
...
*v1.1 — 2026-07-14. Coverage-honesty patch (live dogfood): the connector-list read only
